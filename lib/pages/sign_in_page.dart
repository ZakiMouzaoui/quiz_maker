...
import 'package:quiz_maker/controllers/auth_controller.dart';
import 'package:quiz_maker/pages/sign_up_page.dart';
                          ...
                          builder: (_) => InkWell(
                            onTap: ()async{
                              if(_formKey.currentState!.validate()){
                                final _response = await _signInController.signIn(_emailCtr.text, _passwordCtr.text);
